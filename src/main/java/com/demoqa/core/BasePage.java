...
public class BasePage {
    ...
    public boolean isContainsCssValue(String text, WebElement element, String sccValue) {
        return element.getCssValue(sccValue).contains(text);
    }
    ...
    public void  verifyLinks(String url){
        ...
        try {
            ...
            if (connection.getResponseCode()>=400) {
                softly.fail(url + "-" + connection.getResponseMessage() + "is a brocken link");
               // System.out.println(url + "-" + connection.getResponseMessage() + "is a brocken link");
            }else{
