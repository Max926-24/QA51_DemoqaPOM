...
public class FormTest extends TestBase {
    ...
    public void precondition() {
        ...
        new SidePanel(driver).selectPractiseForm();
    }
    ...
    public void createStudentAccountTest() {
        practiceForm.enterPersonalData("Robert", "Wide", "wide@gm.com", "1234567890")
                ...
                .uploadFile("C:/Tools/tiger1.jpg")
                .inputState("NCR")
                .inputCity("Delhi")
                .submitForm()
                .verifySuccesRegistration("Thanks for submitting the form");
    }


    @RepeatedTest(value = 3,failureThreshold = 1,name ="{displayName}{currentRepetition}/{totalRepetition}" )
    ...
    public void createStudentAccountWithParameterTest(String name, String lastName, String email, String phone) {
    ...
    public void createStudentAccountWithParameterFromClassTest(String name, String lastName, String email, String phone) {
        practiceForm.enterPersonalData(name, lastName, email, phone)
                .selectGender("Male")
                .selectDate("August", "1987", "16")
                .addSubjects(new String[]{"Maths", "Chemistry"})
 ...
 @ParameterizedTest
    ...
    public void createStudentAccountWithParameterFromCsvTest(String name, String lastName, String email, String phone) {
        practiceForm.enterPersonalData(name, lastName, email, phone)
                .selectGender("Male")
                .selectDate("August", "1987", "16")
                .addSubjects(new String[]{"Maths", "Chemistry"})
